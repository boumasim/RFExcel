...
from tests.pyth.integration.data.delete_data import (
	...
	DELETE_ROWS_DUPLICATE_UPDATE_CRITERIA,
	DELETE_ROWS_DUPLICATE_UPDATE_VALUES,
	DELETE_ROWS_NO_MATCH_CRITERIA,
	DELETE_ROWS_NUMERIC_MATCH_CRITERIA,
	DELETE_ROWS_PARTIAL_MATCH_CRITERIA,
	DELETE_ROWS_SECOND_MATCH_CRITERIA,
	DELETE_ROWS_SINGLE_MATCH_CRITERIA,
...
from tests.pyth.test_data import BACKEND_NAMES, BACKENDS, load_backend_copy, open_backend
