...
from rfexcel.utils.library_logger import DefaultLogger, ILogger, RobotLogger

SINGLETON_LOGGERS = [DefaultLogger, RobotLogger]

@pytest.mark.parametrize("logger_class", SINGLETON_LOGGERS)
def test_logger_creates_instance_on_first_call(logger_class: ILogger) -> None:
