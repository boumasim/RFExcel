...
type NativeType = (
    str | int | float | bool | datetime | timedelta
)  # Underlying types returned by libraries
...
type ColumnValues = dict[
    int, InsertNativeType
]  # {column_index : value} used for inserting
