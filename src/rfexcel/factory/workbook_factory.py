...
from rfexcel.rfexcel_constants import VALID_SUFFIXES, XMLX_SUFFIX
...
class WorkbookFactory:
    ...
    def load_workbook(self, path: str, read_only: bool = False, **kwargs):
        ...
        if extension == XMLX_SUFFIX and read_only:
            return self._load_xlsx_stream(path=file_path, **kwargs)
        elif extension == XMLX_SUFFIX and not read_only:
