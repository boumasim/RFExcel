...
class XlsEditResource(IResource):
	...
	def save(self, path: Path | None = None) -> None:
		raise OperationNotSupportedForFormat(".xls format is read-only; saving is not supported. Should be converted to .xlsx format before saving, using the XLSWriter utility.")
